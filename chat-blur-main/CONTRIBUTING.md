...
- Clone the [repository](https://github.com/Sumanth0804/Chat-Blur.git) or [download the zipped file].
...
- Unzip it by right clicking on `chatblur-main` (in your downloads)
...
- Select the locally cloned repository or the unzipped folder (`chatblur-main` in this case) which has `manifest.json` in the root to unpack the extension.
...
- Visit [web.whatsapp.com](https://web.whatsapp.com); because **chatblur** is ready to use.
