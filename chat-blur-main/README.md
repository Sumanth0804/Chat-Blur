...
<table>
    <tr>
        <td>
            <img src='assets/demo_light.png' width="100%" alt='A snapshot of chatblur extension in action with WhatsApp Web in light mode'>
        </td>
    </tr>
    <tr>
      <td>
            <img src='assets/demo_dark.png' width="100%" alt='A snapshot of chatblur extension in action with WhatsApp Web in light mode'>
      </td>
    </tr>
</table>
...
- All of the [potential enhancements] expect a toggle button/checkbox for customizations.
...
<sub>Built with <strike>sweat, blood and love</strike> JavaScript, by <a>Sumanth Nagireddy.</a></sub>
